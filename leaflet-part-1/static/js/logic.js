// create the title layers for the background of the maps
...
//add the default map to the mao
...
.then(function(earthquakeData)
{
        ...
        function dataColor(depth){
            if (depth > 90)
                ...
                return "#fc4903"; //google color picker, copy HEX
            else if (depth > 50)
                return "#fc8403";
            else if (depth >30)
                return "#fcad03";
        ...
        L.geoJson(earthquakeData, {
            ...
            style: dataStyle, //calss the data style function and passes in the earthquake data
            //add popups
...
//add the properties for the legend
    ...
    //with a colored square for each interval
        ...
        for(var i = 0; i< intervals.length; i++) 
        {
            ...
            + intervals[i] 
            + (intervals[i + 1] ? "depth &ndash; " + intervals[i + 1] + "depth<br>" : "+")
            +"<br>";
        }
        return div;
    };
